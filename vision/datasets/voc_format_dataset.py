...
class VOCFormatDataset:
    ...
    def __init__(self, root, transform=None, target_transform=None, is_test=False, keep_difficult=True, label_file=None):
        ...
        self.image_sets_file = self.root / "images.txt"
        ...
        # let all coin types to same class
        for i in range(1, len(self.class_names)):
            self.class_dict[self.class_names[i]] = 1
        self.class_names = ('BACKGROUND', 'coin')

        self.ids = self._read_image_ids(self.image_sets_file)
    ...
    def _read_image_ids(self, image_sets_file):
        ...
        with open(image_sets_file) as f:
            for line in f:
                ...
                annotation_file = self.root / f"{image_id}.xml"
