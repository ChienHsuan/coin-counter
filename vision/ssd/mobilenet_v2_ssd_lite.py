...
from .config import mobilenetv2_ssd_config as config
...
def create_mobilenetv2_ssd_lite(num_classes, width_mult=1.0, use_batch_norm=True, onnx_compatible=False, is_test=False, device=torch.device('cuda')):
